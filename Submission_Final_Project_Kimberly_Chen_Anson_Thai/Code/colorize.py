...
if len(sys.argv) != 4:
    print(
        "Usage: python colorize.py <gray_filename> <scribble_filename> <result_filename>"
    )
    sys.exit(1)
...
scribble_mask = np.any(
    scribble_img != gray_3channel, axis=2
)  # boolean mask of scribbled pixels
